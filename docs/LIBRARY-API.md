...
| `getRgUfSupport` | `() => readonly RgUfCode[]` | Implemented states (9/27: SP, RJ, MG, PR, RS, SC, BA, AC, AL) |
| `getRgPendingUfs` | `() => readonly UfCode[]` | 18 UFs awaiting community implementation |
