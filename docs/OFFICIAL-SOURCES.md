...
| **RG (Registro Geral)** | Per-state SSP/IGP | Full table: [§ RG](#rg--reference-index) | **UF required** — no federal algorithm. **9/27 UFs:** SP, RJ, MG, PR, RS, SC, BA, AC, AL. SP/RJ/MG: Ghiorzi DV tables; PR/RS/BA/AC/AL: format-only; SC: format-only + mask. Vectors: `rg.{sp,rj,mg,pr,rs,sc,ba,ac,al}.official.json`. |
