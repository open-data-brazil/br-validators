...
Express and Fastify middleware for Brazilian document validation — delegates to [`@br-validators/core`](../br-validators) **v1.10.0** `validate*` functions (BR-GENERATE-001 / BR-VALIDATE parity).
